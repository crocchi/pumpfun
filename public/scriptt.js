  ...
  document.getElementById('totPercent').textContent = `Total: ${totalPercent}%`;
      ...
      playScale();
        ...
        searchEl.cells[15].innerHTML = `LiqDrop[${token.stats.liqDrop.toFixed(2)}] Speed[${token.stats.speedLiq.toFixed(2)}] Trend[${token.stats.liqTrend.toFixed(2)}] Trx 1/s[${token.stats.tradesPerSec.toFixed(2)}] Trx/m[${token.stats.tradesPerMin}]`;
                ...
                <td >LiqDrop[${token.stats.liqDrop.toFixed(2)}] Speed[${token.stats.speedLiq.toFixed(2)}] Trend[${token.stats.trend}] Trx 1/s[${token.stats.tradesPerSec.toFixed(2)}] Trx/m[${token.stats.tradesPerMin}]</td>
        ...
        searchEl.cells[8].innerHTML = `LiqDrop[${token.stats?.liqDrop?.toFixed(2) || 'N/A'}] Speed[${token.stats?.speedLiq?.toFixed(2) || 'N/A'}] Trend[${token.stats?.trend || 'N/A'}] Trx 1/s[${token.stats?.tradesPerSec?.toFixed(2) || 'N/A'}] Trx/m[${token.stats?.tradesPerMin || 'N/A'}]`
			} else {
				// Add a new row for the token
				let html = `<tr id='mon${token.id}'>
								...
								<td>${token.time}</td>
								<td>${defiExchange}</td>
								<td >LiqDrop[${token.stats?.liqDrop?.toFixed(2) || 'N/A'}] Speed[${token.stats?.speedLiq?.toFixed(2) || 'N/A'}] Trend[${token.stats?.trend || 'N/A'}] Trx 1/s[${token.stats?.tradesPerSec?.toFixed(2) || 'N/A'}] Trx/m[${token.stats?.tradesPerMin || 'N/A'}]</td>
